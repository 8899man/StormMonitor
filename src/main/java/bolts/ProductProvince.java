...
public class ProductProvince extends BaseRichBolt {

	private static final long serialVersionUID = 1L;
	OutputCollector collector;
	Map<String, Integer> provinceItem = new HashMap<String, Integer>();
	static Logger log = Logger.getLogger(ProductProvince.class);
	...
	public void execute(Tuple input) {
		try {
			...
			String item_id = input.getStringByField(FName.PRODUCT_ID.name());
			int type = 0;
