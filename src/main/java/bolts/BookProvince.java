...
public class BookProvince extends BaseRichBolt {

	private static final long serialVersionUID = 1L;
	OutputCollector collector;
	Map<String, Integer> provinceItem = new HashMap<String, Integer>();
	static Logger log = Logger.getLogger(BookProvince.class);
	...
	public void execute(Tuple input) {
		try {
			...
			String item_id = input.getStringByField(FName.BOOK_ID.name());
			int type = 0;
